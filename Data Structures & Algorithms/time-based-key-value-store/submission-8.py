class TimeMap:
    ...
    def get(self, key: str, timestamp: int) -> str:
        ...
        most_recent_timestamp = l if entry[l][0] <= timestamp else l - 1    # When exact timestamp is not present binary search will end up either on 1st smaller or higher val
